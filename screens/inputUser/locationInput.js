  ...
  return (
    <ImageBackground source={backgroundImage} style={styles.container}>
        ...
        <View style={styles.footerButtons}>
          <TouchableOpacity style={styles.buttonBack} onPress={() => navigation.navigate('City Input')}>
              <Image
                  style={styles.searchIcon}
          ...
          <TouchableOpacity style={styles.buttonHalf} onPress={() => navigation.navigate('Date Input')}>
            <Image
                style={styles.searchIcon}
